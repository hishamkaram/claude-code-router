...
test-live-subscription-pool-fixture:
	$(GO) test -tags=live -count=1 -p 1 -run '^TestLiveFixtureSubscriptionPool(FirstParty|RelaunchesOnFirstParty429|DoesNotRotateOnTemporary429|ModelLimitUsesTransientCooldown|UnclassifiedLimitsUseTransientCooldown|RelaunchesRealClaudeOnFirstParty429|RelaunchesResumedWorktreeRealClaude)$$' ./internal/cli
