...
test-live-subscription-pool-fixture:
	$(GO) test -tags=live -count=1 -p 1 -run '^TestLiveFixtureSubscriptionPool(FirstParty|IsolatesExistingStatuslineCredentials|KeepsFinalLimitedProcessOpen|DoesNotRotateOnTemporary429|ModelLimitUsesTransientCooldown|UnclassifiedLimitsUseTransientCooldown|RelaunchesRealClaudeOnFirstParty429|KeepsRealClaudeOpenWhenAllAccountsLimited|RelaunchesResumedWorktreeRealClaude)$$' ./internal/cli
