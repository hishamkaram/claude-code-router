...
test-live-subscription-pool-fixture:
	$(GO) test -tags=live -count=1 -p 1 -run '^TestLiveFixtureSubscriptionPool(FirstParty|RelaunchesOnFirstParty429|DoesNotRotateOnTemporary429|RelaunchesRealClaudeOnFirstParty429|RelaunchesResumedWorktreeRealClaude)$$' ./internal/cli
