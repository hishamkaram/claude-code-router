...
func runJobStatus(context.Context, *cobra.Command, string, bool) error { return unsupportedJobs() }
func runAdmissionStatus(context.Context, *cobra.Command, string, string, bool) error {
